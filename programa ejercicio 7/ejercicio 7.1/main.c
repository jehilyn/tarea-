...
paea limpiar el bufer, porque generalmente queda con basura y genera un error
...
cadena de caracteres se toma a ese return como el nuevo dato igresado. */
printf("\nEl caracter p3 es: ");
putchar(p3);
/* Se utiliza la funcion putchar para escribir rl caracter almacenado en p3. */
printf("\n");

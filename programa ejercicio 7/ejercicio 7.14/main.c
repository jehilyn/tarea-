...
El programa calcula de manera recursiva la longitud de ka cadena sin utilizar
la funcion strlen. */

int cuenta(char *);  /* prototipos de funciones. */
...
comprender la solucion propuesta, aunque este sea muy simple. Observa que

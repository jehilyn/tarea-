...
typedef struct {       /* Declaracion de la structura alumno. */
    int matricula;
    char nombre[20];
    int carrera;
    float promedio;
...
void lee(FILE *);     /* Prototipos de funcion. */
...
nstrucciones fwrite y fread es moverse y leer o escribir, según sea el caso.

...
ap = fopen("alu1.dat", "r");
/* Observa que los archivos car1.dat, car2.dat, car3.dat, car4.dat y car.dat
se abren en lo modalidad para escribir y leer. */
c1 = fopen("car1.dat", "w+");
c2 = fopen("car2.dat", "w+");
c3 = fopen("car3.dat", "w+");
c4 = fopen("car4.dat", "w+");
...
las carreras de las universidades. */
{
alumno alu;
rewind(ap);
fread(&alu, sizeof(alumno), 1, ap);
...
if (i)
    ...
    cal[4] = 0;
/* Se imprimen los promedios de los alumnos admitidos en  ada carrera. */
for (i=0; i<5; i++)

...
diferentes transacciones que representan las ventas de los diferenres
productos. En el fin de datos esta dado por -1. */
{
int MES, PRO, CAN;
...
de los productos. Observa que el resultado se alamacena en un arreglo

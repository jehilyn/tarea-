...
void funcion2(float [PRO][MES][AÑO], int, int, int);     /* Prototipos de funcioones. */
...
/* Esta funcion se utiliza para localizar la provinvcia que tuvo el menor registro
...
/* Esta funcion se utiliza para localizar el mes con mayor registrode lluvias en

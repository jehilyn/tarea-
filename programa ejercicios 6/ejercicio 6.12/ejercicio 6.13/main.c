...
void Funcion2(float [MES][DEP][AÑO], int, int, int);    /* Prototipos de
funciones. */
...
void Lectura(float A[][DEP][AÑO], int, int, int);
/* Esta funcion lectura se utiliza para leer un arreglo tridimensional nde tipo
...
/* Esta funcion se tuliza para obtener las ventas totales de la empresa
en el segundo año. */
{
int I, J;
float SUM = 0.0;
...
/* Esta funcion se utiliza para obtener el departamento, mes y año con lo mayor
